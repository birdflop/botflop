    ...
    async def analyze_timings(self, message):
        ...
        try:
            ...
            if "1.16.4" not in version:
                embed_var.add_field(
                    name="⚠ Legacy Build", value="Update to 1.16.4.", inline=True
                )
            if using_yatopia:
                embed_var.add_field(
                    name="⚠ Yatopia",
        ...
        try:
            ...
            bungeecord = r["timingsMaster"]["config"]["spigot"]["settings"][
                "bungeecord"
            ]
        ...
        try:
            ...
            if (
                "1.8.0_" in jvm_version
                or jvm_version.startswith("9.")
                or jvm_version.startswith("10.")
            ):
                embed_var.add_field(
                    name="⚠ Java Version", value="Use Java 11.", inline=True
                )
        ...
        try:
            ...
            if "PhantomSMP" in plugins:
                phantoms_only_insomniacs = r["timingsMaster"]["config"]["paper"][
                    "world-settings"
                ]["default"]["phantoms-only-attack-insomniacs"]
        ...
        try:
            network_compression_threshold = int(
                r["timingsMaster"]["config"]["server.properties"][
        ...
        try:
            spigot_view_distance = r["timingsMaster"]["config"]["spigot"][
                "world-settings"
            ]["default"]["view-distance"]
            view_distance = int(
                r["timingsMaster"]["config"]["server.properties"]["view-distance"]
            )
        ...
        try:
            chunk_gc_period = int(
                r["timingsMaster"]["config"]["bukkit"]["chunk-gc"]["period-in-ticks"]
            )
            if chunk_gc_period == 600:
                embed_var.add_field(
                    name="⚠ chunk-gc.period-in-ticks",
        ...
        try:
            ticks_per_monster_spawns = int(
                r["timingsMaster"]["config"]["bukkit"]["ticks-per"]["monster-spawns"]
            )
            if ticks_per_monster_spawns == 1:
                embed_var.add_field(
                    name="⚠ ticks-per.monster-spawns",
        ...
        try:
            monsters_spawn_limit = int(
                r["timingsMaster"]["config"]["bukkit"]["spawn-limits"]["monsters"]
            )
            if monsters_spawn_limit == 70:
                embed_var.add_field(
                    name="⚠ spawn-limits.monsters",
                    value="Decrease this in bukkit.yml.\nRecommended: 15.",
                    inline=True,
                )
        except KeyError:
        ...
        try:
            water_ambient_spawn_limit = int(
                r["timingsMaster"]["config"]["bukkit"]["spawn-limits"]["water-ambient"]
            )
            if water_ambient_spawn_limit == 20:
                embed_var.add_field(
                    name="⚠ spawn-limits.water-ambient",
                    value="Decrease this in bukkit.yml.\nRecommended: 2.",
                    inline=True,
                )
        except KeyError:
        ...
        try:
            ambient_spawn_limit = int(
                r["timingsMaster"]["config"]["bukkit"]["spawn-limits"]["ambient"]
            )
            if ambient_spawn_limit == 15:
                embed_var.add_field(
                    name="⚠ spawn-limits.ambient",
                    value="Decrease this in bukkit.yml.\nRecommended: 1.",
                    inline=True,
                )
        except KeyError:
        ...
        try:
            animals_spawn_limit = int(
                r["timingsMaster"]["config"]["bukkit"]["spawn-limits"]["animals"]
            )
            if animals_spawn_limit == 10:
                embed_var.add_field(
                    name="⚠ spawn-limits.animals",
                    value="Decrease this in bukkit.yml.\nRecommended: 3.",
                    inline=True,
                )
        except KeyError:
        ...
        try:
            water_animals_spawn_limit = int(
                r["timingsMaster"]["config"]["bukkit"]["spawn-limits"]["water-animals"]
            )
            if water_animals_spawn_limit == 15:
                embed_var.add_field(
                    name="⚠ spawn-limits.water-animals",
                    value="Decrease this in bukkit.yml.\nRecommended: 2.",
                    inline=True,
                )
        except KeyError:
        ...
        try:
            mob_spawn_range = int(
                r["timingsMaster"]["config"]["spigot"]["world-settings"]["default"][
                    "mob-spawn-range"
                ]
            )
            spigot_view_distance = r["timingsMaster"]["config"]["spigot"][
        ...
        try:
            ...
            if animals_entity_activation_range == 32:
                embed_var.add_field(
                    name="⚠ entity-activation-range.animals",
                    value="Decrease this in spigot.yml. " "Recommended: 6.",
                    inline=True,
                )
        except KeyError:
            unchecked = unchecked + 1
        ...
        try:
            ...
            if monsters_entity_activation_range == 32:
                embed_var.add_field(
                    name="⚠ entity-activation-range.monsters",
                    value="Decrease this in spigot.yml. " "Recommended: 16.",
                    inline=True,
                )
        except KeyError:
            unchecked = unchecked + 1
        ...
        try:
            ...
            if misc_entity_activation_range == 16:
                embed_var.add_field(
                    name="⚠ entity-activation-range.misc",
                    value="Decrease this in spigot.yml. " "Recommended: 4.",
                    inline=True,
                )
        except KeyError:
            unchecked = unchecked + 1
        ...
        try:
            ...
            if water_entity_activation_range == 16:
                embed_var.add_field(
                    name="⚠ entity-activation-range.water",
                    value="Decrease this in spigot.yml. " "Recommended: 12.",
                    inline=True,
                )
        except KeyError:
            unchecked = unchecked + 1
        ...
        try:
            ...
            if villagers_entity_activation_range == 32:
                embed_var.add_field(
                    name="⚠ entity-activation-range.villagers",
                    value="Decrease this in spigot.yml. " "Recommended: 16.",
                    inline=True,
                )
        except KeyError:
        ...
        try:
            tick_inactive_villagers = r["timingsMaster"]["config"]["spigot"][
                "world-settings"
            ]["default"]["entity-activation-range"]["tick-inactive-villagers"]
        ...
        try:
            nerf_spawner_mobs = r["timingsMaster"]["config"]["spigot"][
                "world-settings"
            ]["default"]["nerf-spawner-mobs"]
        ...
        try:
            ...
            if wake_up_inactive_villagers_for == 100:
                embed_var.add_field(
                    name="⚠ wake-up-inactive.villagers-for",
                    value="Decrease this in spigot.yml. " "Recommended: 20.",
                    inline=True,
                )
        except KeyError:
            unchecked = unchecked + 1
        ...
        try:
            ...
            if wake_up_inactive_flying_monsters_for == 100:
                embed_var.add_field(
                    name="⚠ wake-up-inactive.flying-monsters-for",
                    value="Decrease this in spigot.yml. " "Recommended: 60.",
                    inline=True,
                )
        except KeyError:
            unchecked = unchecked + 1
        ...
        try:
            ...
            if wake_up_inactive_villagers_max_per_tick == 4:
                embed_var.add_field(
                    name="⚠ wake-up-inactive.villagers-max-per-tick",
                    value="Decrease this in spigot.yml. " "Recommended: 1.",
                    inline=True,
                )
        except KeyError:
            unchecked = unchecked + 1
        ...
        try:
            ...
            if wake_up_inactive_animals_for == 100:
                embed_var.add_field(
                    name="⚠ wake-up-inactive.animals-for",
                    value="Decrease this in spigot.yml. " "Recommended: 40.",
                    inline=True,
                )
        except KeyError:
            unchecked = unchecked + 1
        ...
        try:
            ...
            if wake_up_inactive_monsters_max_per_tick == 8:
                embed_var.add_field(
                    name="⚠ wake-up-inactive.monsters-max-per-tick",
                    value="Decrease this in spigot.yml. " "Recommended: 4.",
                    inline=True,
                )
        except KeyError:
        ...
        try:
            ...
            if wake_up_inactive_flying_monsters_max_per_tick == 8:
                embed_var.add_field(
                    name="⚠ wake-up-inactive.flying-monsters-max-per-tick",
                    value="Decrease this in spigot.yml. " "Recommended: 1.",
                    inline=True,
                )
        except KeyError:
        ...
        try:
            ...
            if wake_up_inactive_animals_max_per_tick == 4:
                embed_var.add_field(
                    name="⚠ wake-up-inactive.animals-max-per-tick",
                    value="Decrease this in spigot.yml. " "Recommended: 2.",
                    inline=True,
                )
        except KeyError:
            unchecked = unchecked + 1
        ...
        try:
            ...
            if wake_up_inactive_monsters_for == 100:
                embed_var.add_field(
                    name="⚠ wake-up-inactive.monsters-for",
                    value="Decrease this in spigot.yml. " "Recommended: 60.",
                    inline=True,
                )
        except KeyError:
        ...
        try:
            ...
            if arrow_despawn_rate == 1200:
                embed_var.add_field(
                    ...
                    value="Decrease this in spigot.yml. " "Recommended: 300.",
                    inline=True,
                )
        except KeyError:
            unchecked = unchecked + 1
        ...
        try:
            ...
            if item_merge_radius == 2.5:
                embed_var.add_field(
                    name="⚠ merge-radius.item",
                    value="Increase this in spigot.yml. " "Recommended: 4.0.",
                    inline=True,
                )
        except KeyError:
            unchecked = unchecked + 1
        ...
        try:
            ...
            if exp_merge_radius == 3.0:
                embed_var.add_field(
                    name="⚠ merge-radius.exp",
                    value="Increase this in spigot.yml. " "Recommended: 6.0.",
                    inline=True,
                )
        except KeyError:
            unchecked = unchecked + 1
        ...
        try:
            max_auto_save_chunks_per_tick = int(
                r["timingsMaster"]["config"]["paper"]["world-settings"]["default"][
            ...
            if max_auto_save_chunks_per_tick == 24:
                embed_var.add_field(
                    ...
                    value="Decrease this in paper.yml. " "Recommended: 6.",
                    inline=True,
                )
        except KeyError:
            unchecked = unchecked + 1
        ...
        try:
            optimize_explosions = r["timingsMaster"]["config"]["paper"][
                "world-settings"
            ]["default"]["optimize-explosions"]
        ...
        try:
            ...
            if mob_spawner_tick_rate == 1:
                embed_var.add_field(
                    name="⚠ mob-spawner-tick-rate",
                    value="Increase this in paper.yml. " "Recommended: 2.",
                    inline=True,
                )
        except KeyError:
            unchecked = unchecked + 1
        ...
        try:
            disable_chest_cat_detection = r["timingsMaster"]["config"]["paper"][
                "world-settings"
            ]["default"]["game-mechanics"]["disable-chest-cat-detection"]
            if disable_chest_cat_detection == "false":
                embed_var.add_field(
                    name="⚠ disable-chest-cat-detection",
                    value="Enable this in paper.yml.",
                    inline=True,
                )
        except KeyError:
        ...
        try:
            ...
            if container_update_tick_rate == "false":
                embed_var.add_field(
                    name="⚠ container-update-tick-rate",
                    value="Increase this in paper.yml. " "Recommended: 3.",
                    inline=True,
                )
        except KeyError:
            unchecked = unchecked + 1
        ...
        try:
            ...
            if grass_spread_tick_rate == 1:
                embed_var.add_field(
                    name="⚠ grass-spread-tick-rate",
                    value="Increase this in paper.yml. " "Recommended: 4",
                    inline=True,
                )
        except KeyError:
            unchecked = unchecked + 1
        ...
        try:
            ...
            if soft_despawn_range == 32:
                embed_var.add_field(
                    name="⚠ despawn-ranges.soft",
                    value="Decrease this in paper.yml. " "Recommended: 28",
                    inline=True,
                )
        except KeyError:
            unchecked = unchecked + 1
        ...
        try:
            ...
            if hard_despawn_range == 128:
                embed_var.add_field(
                    name="⚠ despawn-ranges.hard",
                    value="Decrease this in paper.yml. " "Recommended: 48",
                    inline=True,
                )
        except KeyError:
            unchecked = unchecked + 1
        ...
        try:
            hopper_disable_move_event = r["timingsMaster"]["config"]["paper"][
                "world-settings"
            ]["default"]["hopper"]["disable-move-event"]
            if hopper_disable_move_event == "false":
                embed_var.add_field(
                    name="⚠ hopper.disable-move-event",
                    value="Enable this in paper.yml.",
                    inline=True,
                )
        except KeyError:
        ...
        try:
            ...
            if non_player_arrow_despawn_rate == -1:
                embed_var.add_field(
                    name="⚠ non-player-arrow-despawn-rate",
                    value="Set a value in paper.yml. " "Recommended: 60",
                    inline=True,
                )
        except KeyError:
            unchecked = unchecked + 1
        ...
        try:
            ...
            if creative_arrow_despawn_rate == -1:
                embed_var.add_field(
                    name="⚠ creative-arrow-despawn-rate",
                    value="Set a value in paper.yml. " "Recommended: 60",
                    inline=True,
                )
        except KeyError:
        ...
        try:
            prevent_moving_into_unloaded_chunks = r["timingsMaster"]["config"]["paper"][
                "world-settings"
            ]["default"]["prevent-moving-into-unloaded-chunks"]
        ...
        try:
            eigencraft_redstone = r["timingsMaster"]["config"]["paper"][
                "world-settings"
            ]["default"]["use-faster-eigencraft-redstone"]
            if eigencraft_redstone == "false":
                embed_var.add_field(
                    name="⚠ use-faster-eigencraft-redstone",
                    value="Enable this in paper.yml.",
                    inline=True,
                )
        except KeyError:
        ...
        try:
            plugins = r["timingsMaster"]["plugins"]
            armor_stands_tick = r["timingsMaster"]["config"]["paper"]["world-settings"][
                "default"
            ]["armor-stands-tick"]
            if (
                armor_stands_tick == "true"
                and "PetBlocks" not in plugins
                and "BlockBalls" not in plugins
                and "ArmorStandTools" not in plugins
            ):
                embed_var.add_field(
        ...
        try:
            per_player_mob_spawns = r["timingsMaster"]["config"]["paper"][
                "world-settings"
            ]["default"]["per-player-mob-spawns"]
            if per_player_mob_spawns == "false":
                embed_var.add_field(
                    name="⚠ per-player-mob-spawns",
                    value="Enable this in paper.yml.",
                    inline=True,
                )
        except KeyError:
        ...
        try:
            alt_item_despawn_rate_enabled = r["timingsMaster"]["config"]["paper"][
                "world-settings"
            ]["default"]["alt-item-despawn-rate"]["enabled"]
            if alt_item_despawn_rate_enabled == "false":
                embed_var.add_field(
                    name="⚠ alt-item-despawn-rate.enabled",
                    value="Enable this in paper.yml.",
                    inline=True,
                )
        except KeyError:
        ...
        try:
            ...
            if no_tick_view_distance == -1:
                ...
                if spigot_view_distance == "default":
                    ...
                    if view_distance >= 4:
                        embed_var.add_field(
                            name="⚠ no-tick-view-distance",
                            value="Set a value in paper.yml. "
                            "Recommended: "
                            + str(view_distance)
                            + ". And reduce view-distance in server.properties. Recommended: 3.",
                            inline=True,
                        )
                    ...
                    embed_var.add_field(
                        ...
                        value="Set a value in paper.yml. "
                        "Recommended: "
                        + spigot_view_distance
                        + ". And reduce view-distance in spigot.yml. Recommended: 3.",
                        inline=True,
                    )
        except KeyError:
            unchecked = unchecked + 1
        ...
        try:
            enable_treasure_maps = r["timingsMaster"]["config"]["paper"][
                "world-settings"
            ]["default"]["enable-treasure-maps"]
            if enable_treasure_maps == "true":
                embed_var.add_field(
                    name="⚠ enable-treasure-maps",
        ...
        try:
            ...
            if projectile_load_save == -1:
                embed_var.add_field(
                    name="⚠ projectile-load-save-per-chunk-limit",
        ...
        try:
            use_alternate_keepalive = r["timingsMaster"]["config"]["purpur"][
                "settings"
            ]["use-alternate-keepalive"]
            if use_alternate_keepalive == "false" and "TCPShield" not in plugins:
                embed_var.add_field(
                    name="⚠ use-alternate-keepalive",
        ...
        try:
            dont_send_useless_entity_packets = r["timingsMaster"]["config"]["purpur"][
                "settings"
            ]["dont-send-useless-entity-packets"]
            if dont_send_useless_entity_packets == "false":
                embed_var.add_field(
                    name="⚠ dont-send-useless-entity-packets",
                    value="Enable this in purpur.yml.",
                    inline=True,
                )
        except KeyError:
        ...
        try:
            disable_treasure_searching = r["timingsMaster"]["config"]["purpur"][
                "world-settings"
            ]["default"]["mobs"]["dolphin"]["disable-treasure-searching"]
        ...
        try:
            brain_ticks = int(
                r["timingsMaster"]["config"]["purpur"]["world-settings"]["default"][
                    "mobs"
                ]["villager"]["brain-ticks"]
            )
            if brain_ticks == 1:
                embed_var.add_field(
                    name="⚠ villager.brain-ticks",
                    value="Increase this in purpur.yml. " "Recommended: 4.",
                    inline=True,
                )
        except KeyError:
            unchecked = unchecked + 1
        ...
        try:
            iron_golem_radius = int(
                r["timingsMaster"]["config"]["purpur"]["world-settings"]["default"][
                    "mobs"
                ]["villager"]["spawn-iron-golem"]["radius"]
            )
            if iron_golem_radius == 0:
                embed_var.add_field(
                    name="⚠ spawn-iron-golem.radius",
                    value="Set a value in purpur.yml. " "Recommended: 32.",
                    inline=True,
                )
        except KeyError:
            unchecked = unchecked + 1
        ...
        try:
            iron_golem_limit = int(
                r["timingsMaster"]["config"]["purpur"]["world-settings"]["default"][
                    "mobs"
                ]["villager"]["spawn-iron-golem"]["limit"]
            )
            if iron_golem_limit == 0:
                embed_var.add_field(
                    name="⚠ spawn-iron-golem.limit",
                    value="Set a value in purpur.yml. " "Recommended: 5.",
                    inline=True,
                )
        except KeyError:
            unchecked = unchecked + 1
        ...
        try:
            aggressive_towards_villager_when_lagging = r["timingsMaster"]["config"][
                "purpur"
            ]["world-settings"]["default"]["mobs"]["zombie"][
                "aggressive-towards-villager-when-lagging"
            ]
            if aggressive_towards_villager_when_lagging == "true":
                embed_var.add_field(
                    name="⚠ zombie.aggresive-towards-villager-when-lagging",
        ...
        try:
            entities_can_use_portals = r["timingsMaster"]["config"]["purpur"][
                "world-settings"
            ]["default"]["gameplay-mechanics"]["entities-can-use-portals"]
            if entities_can_use_portals == "true":
                embed_var.add_field(
                    name="⚠ entities-can-use-portals",
        ...
        try:
            lobotomize_enabled = r["timingsMaster"]["config"]["purpur"][
                "world-settings"
            ]["default"]["mobs"]["villager"]["lobotomize"]["enabled"]
            if lobotomize_enabled == "false":
                embed_var.add_field(
                    name="⚠ villager.lobotomize.enabled",
                    value="Enable this in purpur.yml.",
                    inline=True,
                )
        except KeyError:
        ...
        try:
            teleport_if_outside_border = r["timingsMaster"]["config"]["purpur"][
                "world-settings"
            ]["default"]["gameplay-mechanics"]["player"]["teleport-if-outside-border"]
            if teleport_if_outside_border == "false":
                embed_var.add_field(
                    name="⚠ player.teleport-if-outside-border",
                    value="Enable this in purpur.yml.",
                    inline=True,
                )
        except KeyError:
        ...
        if len(embed_var.fields) == 0:
            embed_var.add_field(name="✅ All good", value="Analyzed with no issues")
            await message.channel.send(embed=embed_var)
            return
        ...
        if issue_count > 25:
            embed_var.description = (
                ...
                + " recommendations.\n||"
                + str(unchecked)
                + " missing optimizations due to server version.||"
            )
        else:
            embed_var.description = (
                embed_var.description
